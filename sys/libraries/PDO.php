...
class ED_PDO
{
	...
	*/
	...
	{
		if (file_exists(SYSPATH.'libraries/PDOCon.php'))
		{
			require_once(SYSPATH.'libraries/PDOCon.php');
			...
			{
				exit('PDO->PDOCon:PDOCon class does not exists.');
			}
		}
		else
		{
			exit('PDO->PDOCon:PDOCon file does not exists.');
		}
	}
